...
# Canon beyond TNET/SS: official dabas + occupied-territory towns the pickers
# miss, self-governed Abkhazia communities, and the official region map
# (Geostat). Regions list every city and municipality exactly once; the
# 'აფხაზეთის ავტონომიური რესპუბლიკა' / 'ქუთაისის მუნიციპალიტეტი' legacy
# containers are exempt (not real municipalities).
CANON_CITIES = [
  'ადიგენი', 'ასპინძა', 'ახალგორი', 'თიანეთი', 'ხარაგაული', 'შუახევი', 'ლენტეხი',
  'სურამი', 'ჩხოროწყუ', 'სოხუმი', 'გაგრა', 'გუდაუთა', 'ოჩამჩირე', 'ტყვარჩელი',
  'გალი', 'ახალ ათონი', 'ბიჭვინთა', 'ლესელიძე', 'გულრიფში',
  'ქედა', 'ჩოხატაური', 'ხულო', 'პასანაური',
  'აგარა', 'კოჯორი', 'წეროვანი',
  # სტეფანწმინდა stays out — same town as ყაზბეგი (TNET/SS/inventory name);
  # the official name resolves as a /api/suggest alias instead of a 2nd city.
]
CANON_MUNIS = [
...
CANON_REGIONS = {
  'თბილისი': (['თბილისი'], []),
  'აჭარა': (['ბათუმი', 'ქობულეთი', 'ხელვაჩაური', 'შუახევი', 'ქედა', 'ხულო'], ['ქედის მუნიციპალიტეტი', 'ქობულეთის მუნიციპალიტეტი', 'შუახევის მუნიციპალიტეტი', 'ხელვაჩაურის მუნიციპალიტეტი', 'ხულოს მუნიციპალიტეტი']),
  'გურია': (['ოზურგეთი', 'ლანჩხუთი', 'ჩოხატაური'], ['ოზურგეთის მუნიციპალიტეტი', 'ლანჩხუთის მუნიციპალიტეტი', 'ჩოხატაურის მუნიციპალიტეტი']),
  'იმერეთი': (['ქუთაისი', 'ზესტაფონი', 'თერჯოლა', 'ტყიბული', 'საჩხერე', 'ბაღდათი', 'ვანი', 'ხონი', 'ჭიათურა', 'ხარაგაული', 'წყალტუბო'], ['ბაღდათის მუნიციპალიტეტი', 'ვანის მუნიციპალიტეტი', 'ზესტაფონის მუნიციპალიტეტი', 'თერჯოლის მუნიციპალიტეტი', 'ტყიბულის მუნიციპალიტეტი', 'საჩხერის რაიონი', 'ჭიათურის მუნიციპალიტეტი', 'ხარაგაულის მუნიციპალიტეტი', 'ხონის მუნიციპალიტეტი', 'წყალტუბოს მუნიციპალიტეტი']),
  'კახეთი': (['თელავი', 'გურჯაანი', 'დედოფლისწყარო', 'ლაგოდეხი', 'საგარეჯო', 'სიღნაღი', 'ახმეტა', 'ყვარელი', 'წნორი'], ['ახმეტის მუნიციპალიტეტი', 'გურჯაანის მუნიციპალიტეტი', 'დედოფლისწყაროს მუნიციპალიტეტი', 'თელავის მუნიციპალიტეტი', 'ლაგოდეხის მუნიციპალიტეტი', 'საგარეჯოს მუნიციპალიტეტი', 'სიღნაღის მუნიციპალიტეტი', 'ყვარლის მუნიციპალიტეტი']),
  'მცხეთა-მთიანეთი': (['მცხეთა', 'დუშეთი', 'მანგლისი', 'ყაზბეგი', 'გუდაური', 'ხევსურეთი', 'ახალგორი', 'თიანეთი', 'პასანაური', 'წეროვანი'], ['ახალგორის მუნიციპალიტეტი', 'დუშეთის მუნიციპალიტეტი', 'თიანეთის მუნიციპალიტეტი', 'მცხეთის მუნიციპალიტეტი', 'ყაზბეგის მუნიციპალიტეტი']),
  'რაჭა-ლეჩხუმი და ქვემო სვანეთი': (['ამბროლაური', 'ონი', 'ცაგერი', 'ლენტეხი'], ['ამბროლაურის მუნიციპალიტეტი', 'ლენტეხის მუნიციპალიტეტი', 'ონის რაიონი', 'ცაგერის მუნიციპალიტეტი']),
  'სამეგრელო-ზემო სვანეთი': (['ზუგდიდი', 'აბაშა', 'მარტვილი', 'სამტრედია', 'სენაკი', 'ჩხოროწყუ', 'წალენჯიხა', 'ხობი', 'თეთრიწყარო', 'მესტია', 'ფოთი'], ['აბაშის მუნიციპალიტეტი', 'ზუგდიდის მუნიციპალიტეტი', 'თეთრიწყაროს მუნიციპალიტეტი', 'მარტვილის მუნიციპალიტეტი', 'მესტიის მუნიციპალიტეტი', 'სამტრედიის მუნიციპალიტეტი', 'სენაკის რაიონი', 'ჩხოროწყუს მუნიციპალიტეტი', 'წალენჯიხის მუნიციპალიტეტი', 'ხობის მუნიციპალიტეტი']),
  'სამცხე-ჯავახეთი': (['ახალციხე', 'ბორჯომი', 'ვალე', 'ახალქალაქი', 'ნინოწმინდა', 'ბაკურიანი', 'აბასთუმანი', 'ასპინძა', 'ადიგენი'], ['ადიგენის მუნიციპალიტეტი', 'ასპინძის მუნიციპალიტეტი', 'ახალქალაქის მუნიციპალიტეტი', 'ახალციხის მუნიციპალიტეტი', 'ბორჯომის მუნიციპალიტეტი', 'ნინოწმინდის რაიონი']),
  'ქვემო ქართლი': (['რუსთავი', 'მარნეული', 'ბოლნისი', 'დმანისი', 'გარდაბანი', 'წალკა', 'კოჯორი'], ['ბოლნისის მუნიციპალიტეტი', 'გარდაბნის მუნიციპალიტეტი', 'დმანისის რაიონი', 'მარნეულის მუნიციპალიტეტი', 'წალკის მუნიციპალიტეტი']),
  'შიდა ქართლი': (['გორი', 'ხაშური', 'კასპი', 'ქარელი', 'ცხინვალი', 'ჯავა', 'სურამი', 'აგარა'], ['გორის მუნიციპალიტეტი', 'კასპის მუნიციპალიტეტი', 'ქარელის მუნიციპალიტეტი', 'ხაშურის მუნიციპალიტეტი', 'ცხინვალის რაიონი']),
  'აფხაზეთი': (['აფხაზეთი', 'სოხუმი', 'გაგრა', 'გუდაუთა', 'ოჩამჩირე', 'ტყვარჩელი', 'გალი', 'ახალ ათონი', 'ბიჭვინთა', 'ლესელიძე', 'გულრიფში'], ['გაგრის მუნიციპალიტეტი', 'გუდაუთის მუნიციპალიტეტი', 'სოხუმის მუნიციპალიტეტი', 'გულრიფშის მუნიციპალიტეტი', 'ოჩამჩირის მუნიციპალიტეტი', 'ტყვარჩელის მუნიციპალიტეტი', 'გალის მუნიციპალიტეტი']),
}


def apply_canon(cities: list[str], munis: list[str]) -> tuple[list[str], list[str]]:
  cities = list(dict.fromkeys(cities + sorted(set(CANON_CITIES) - set(cities), key=lambda x: x.casefold())))
  munis = sorted(set(munis) | set(CANON_MUNIS), key=lambda x: x.casefold())
  return cities, munis
...
def main() -> None:
  ...
  cities_ordered, munis_ordered = apply_canon(cities_ordered, munis_ordered)
  geo['cities'] = cities_ordered
  geo['municipalities'] = munis_ordered
  geo['regions'] = {
    r: {'cities': sorted(cs, key=lambda x: x.casefold()), 'munis': sorted(ms, key=lambda x: x.casefold())}
    for r, (cs, ms) in CANON_REGIONS.items()
  }
