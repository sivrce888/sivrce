...
CANON_REGIONS = {
  ...
  'მცხეთა-მთიანეთი': (['მცხეთა', 'დუშეთი', 'მანგლისი', 'ყაზბეგი', 'გუდაური', 'ხევსურეთი', 'ახალგორი', 'თიანეთი', 'პასანაური'], ['ახალგორის მუნიციპალიტეტი', 'დუშეთის მუნიციპალიტეტი', 'თიანეთის მუნიციპალიტეტი', 'მცხეთის მუნიციპალიტეტი', 'ყაზბეგის მუნიციპალიტეტი']),
  ...
  'ქვემო ქართლი': (['რუსთავი', 'მარნეული', 'ბოლნისი', 'დმანისი', 'გარდაბანი', 'წალკა'], ['ბოლნისის მუნიციპალიტეტი', 'გარდაბნის მუნიციპალიტეტი', 'დმანისის რაიონი', 'მარნეულის მუნიციპალიტეტი', 'წალკის მუნიციპალიტეტი']),
  'შიდა ქართლი': (['გორი', 'ხაშური', 'კასპი', 'ქარელი', 'ცხინვალი', 'ჯავა', 'სურამი'], ['გორის მუნიციპალიტეტი', 'კასპის მუნიციპალიტეტი', 'ქარელის მუნიციპალიტეტი', 'ხაშურის მუნიციპალიტეტი', 'ცხინვალის რაიონი']),
