...
CANON_REGIONS = {
  'თბილისი': (['თბილისი'], []),
  'აჭარა': (['ბათუმი', 'ქობულეთი', 'ხელვაჩაური', 'შუახევი'], ['ქედის მუნიციპალიტეტი', 'ქობულეთის მუნიციპალიტეტი', 'შუახევის მუნიციპალიტეტი', 'ხელვაჩაურის მუნიციპალიტეტი', 'ხულოს მუნიციპალიტეტი']),
  'გურია': (['ოზურგეთი', 'ლანჩხუთი'], ['ოზურგეთის მუნიციპალიტეტი', 'ლანჩხუთის მუნიციპალიტეტი', 'ჩოხატაურის მუნიციპალიტეტი']),
  ...
  'მცხეთა-მთიანეთი': (['მცხეთა', 'დუშეთი', 'მანგლისი', 'ყაზბეგი', 'გუდაური', 'ხევსურეთი', 'ახალგორი', 'თიანეთი'], ['ახალგორის მუნიციპალიტეტი', 'დუშეთის მუნიციპალიტეტი', 'თიანეთის მუნიციპალიტეტი', 'მცხეთის მუნიციპალიტეტი', 'ყაზბეგის მუნიციპალიტეტი']),
