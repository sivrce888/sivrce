...
const csp = [
  ...
  `img-src 'self' data: blob: https://cdn.sivrce.ge https://images.sivrce.ge https://i.ytimg.com https://videodelivery.net https://lh3.googleusercontent.com https://upload.wikimedia.org https://commons.wikimedia.org${capacitorOrigins}${mapOrigins}${mediaOrigins}${analyticsOrigins}`,
  "font-src 'self' data:",
  `connect-src 'self'${capacitorOrigins} https://sivrce.ge https://*.sivrce.ge https://sivrce.com https://*.sivrce.com https://sivrce.de https://*.sivrce.de https://sivrce.ae https://*.sivrce.ae https://*.videodelivery.net${mapOrigins}${analyticsOrigins}${featureApiOrigins}`,
