...
export const metadata: Metadata = {
  title: 'შენობები და კორპუსები თბილისში და ბათუმში — კოდი, კოორდინატები, განცხადებები',
  description:
    'აქსის თაუერსი, ქინგ დევიდი და ყველა ცნობილი კორპუსი: უნიკალური კოდი, კოორდინატები, დეველოპერი, შეფასება — იყიდება, ქირავდება, დღიურად, გირავდება ერთ სივრცეში.',
  alternates: { canonical: '/buildings' },
  openGraph: {
    title: 'შენობები და კორპუსები | sivrce',
    description:
      'ცნობილი კორპუსები უნიკალური კოდითა და კოორდინატებით — დააჭირე და ნახე რა იყიდება ან ქირავდება.',
    type: 'website',
  },
}
      ...
      <main id="main" className="pt-16">
        <section className="mx-auto max-w-[1440px] px-5 py-12 md:px-10 md:py-16">
          ...
          <p className="mt-2 max-w-2xl text-[15px] font-semibold text-sv-ink/65 md:text-[16px]">
            ყოველ შენობას აქვს უნიკალური კოდი, კოორდინატები და ქარდი — შეეხე და ნახე რა იყიდება,
            ქირავდება, დღიურად ან გირავდება
          </p>
