  ...
  ka: {
    ...
    faqs: [
      ...
      },
      {
        ...
        a: 'დიახ. შეგიძლიათ აირჩიოთ ქალაქი, რაიონი (ვაკე, საბურთალო, გლდანი…) და უბანი (ლისი, დიდი დიღომი, ვარკეთილი…). ძიება მუშაობს სახელწოდებით, მისამართითა და დეველოპერით.',
      },
      {
...
export default async function BuildingsPage({ params }: { params: Promise<{ lang: string }> }) {
  ...
  const breadcrumbLd = {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 2, name: c.title, item: 'https://sivrce.ge/buildings' },
    ],
  }
