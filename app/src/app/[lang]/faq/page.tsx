  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: 'ბუსტი არის დამატებითი ხილვადობა VIP-ის გარდა: განახლება, ფერი, Facebook და Turbo. ფასიანი სტიკერები მხოლოდ ორია — „სასწრაფოდ“ და „ფასი დაწეულია“ — ბარათზე და განცხადების გვერდზე. აუზი, პარკინგი, ავეჯი და სხვა მახასიათებლები უფასო რჩება.',
      },
      {
