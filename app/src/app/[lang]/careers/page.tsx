...
const BENEFITS = [
  {
    ...
    text: 'მოთხოვნები ვებგვერდიდან და აპიდან მოდის. ქუჩაში მყიდველს აღარ ეძებ.',
  },
  {
    icon: Wallet,
    title: 'შემოსავალი გაყიდვებიდან',
    text: 'კომისია დახურულ გარიგებაზე. რაც მეტს ყიდი, მით მეტს იღებ. პირობები ინტერვიუზე გეტყვიან.',
  },
  {
    icon: Clock3,
    title: 'შენი გრაფიკი',
