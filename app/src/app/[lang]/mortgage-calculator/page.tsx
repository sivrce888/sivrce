...
const COPY: Record<DirLoc, {
  ...
  ka: {
    ...
    ratesNote: 'პროცენტები ასახავს 2026 წლის ბაზარს და შეიძლება შეიცვალოს. ზუსტი პირობებისთვის დაუკავშირდით კონკრეტულ ბანკს.',
    ...
    guide: [
      ...
      'სტანდარტული მოთხოვნები: 21+ წლის ასაკი, საქართველოში მიღებული შემოსავლის დადასტურება (ბოლო 3-6 თვის ამონაწერი), საკუთრების დაზღვევა. არარეზიდენტებისთვის ხშირად უფრო მოკლე ვადა და უფრო დიდი პირველი შენატანია.',
    ...
    faqs: [
      { q: 'რა არის მინიმალური პირველი შენატანი იპოთეკაზე საქართველოში?', a: 'რეზიდენტი მოქალაქეებისთვის მინიმალური პირველი შენატანი ჩვეულებრივ 10-20% იყო, თუმცა 2026 წლის ბაზარზე ბანკების უმრავლესობა ითხოვს 20-30%-ს. არარეზიდენტებისთვის მოთხოვნა ხშირად 30-50%-მდე იზრდება, რადგან საქართველოში მიღებული შემოსავალი არ აქვთ.' },
      { q: 'რომელი ბანკი იძლევა საუკეთესო იპოთეკურ პირობებს 2026-ში?', a: 'ბაზარზე მოქმედი ძირითადი მოთამაშეებია Bank of Georgia, TBC Bank, Credo Bank და BasisBank. პროცენტი მერყეობს 8-13%-ის ფარგლებში ლარში და 6-9%-ის ფარგლებში უცხოურ ვალუტაში (მრავალწლიანი ვადით). კონკრეტული პირობები დამოკიდებულია შემოსავალზე, კრედიტის ისტორიაზე და ქონების ტიპზე.' },
      ...
      { q: 'რა დამატებითი ხარჯები მოსდევს ქონების ყიდვას?', a: 'ქონების გადაცემის გადასახადი შეადგენს შეფასებული ღირებულების პირველ 100,000 ლარზე 1%-ს, ზემოთ კი 2%-ს. ნოტარიული და რეესტრის გადასახადი ჩვეულებრივ 150-300 დოლარია. აგენტის საკომისიო მერყეობს 1-3%-ის ფარგლებში (ჩვეულებრივ გამყიდველი იხდის ან მხარეებს შორის იყოფა). საჯარო რეესტრში საკუთრების რეგისტრაცია დასრულდება 1-4 სამუშაო დღეში.' },
