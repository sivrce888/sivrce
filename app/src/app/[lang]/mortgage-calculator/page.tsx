...
const COPY: Record<DirLoc, {
  ...
  ka: {
    ...
    guide: [
      'იპოთეკა საქართველოში ჩვეულებრივ გაიცემა ლარში (GEL) ან უცხოურ ვალუტაში (USD/EUR). ლარის პროცენტი მაღალია (8-13%), მაგრამ არ არის სავალუტო რისკი. უცხოური ვალუტის პროცენტი დაბალია (6-9%), მაგრამ გაცვლითი კურსის რყევა შეიძლება გაზარდოს თქვენი ყოველთვიური გადასახადი.',
