...
const HUB = {
  ka: {
    ...
    sub: 'რემონტი, ინსპექცია, იურიდიული, ფოტო, კლიმატი, მზის ენერგია, გადატანა, მართვა და სხვა — ვერიფიცირებული კომპანიები ერთ პლატფორმაზე.',
  ...
  en: {
    ...
    sub: 'Renovation, inspection, legal, photo, climate, solar, moving, management and more — verified companies on one platform.',
  ...
  ru: {
    ...
    sub: 'Ремонт, обследование, юристы, фото, климат, солнечная энергия, переезд, управление и другое — проверенные компании на одной платформе.',
  ...
  de: {
    ...
    sub: 'Renovierung, Inspektion, Recht, Fotografie, Klima, Solar, Umzug, Verwaltung und mehr — verifizierte Firmen auf einer Plattform.',
