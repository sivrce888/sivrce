...
const L: Record<DirLoc | 'de', Labels> = {
  ka: {
    ...
    devAria: 'დეველოპერი',
    sortAria: 'დალაგება',
    sorts: { rec: 'რეკომენდებული', value: 'მედიანაზე იაფი', price: 'ფასი: ზრდადი', 'price-desc': 'ფასი: კლებადი', handover: 'ჩაბარება: მალე', progress: 'მშენებლობა: დაწინაურებული' },
    results: (n) => `${n} პროექტი`,
    more: 'ნახე მეტი',
    clear: 'გასუფთავება',
  ...
  en: {
    ...
    devAria: 'Developer',
    sortAria: 'Sort',
    sorts: { rec: 'Recommended', value: 'Best value vs district', price: 'Price: low to high', 'price-desc': 'Price: high to low', handover: 'Handover: soonest', progress: 'Construction: most advanced' },
  ...
  ru: {
    ...
    devAria: 'Застройщик',
    sortAria: 'Сортировка',
    sorts: { rec: 'Рекомендованные', value: 'Дешевле медианы района', price: 'Цена: по возрастанию', 'price-desc': 'Цена: по убыванию', handover: 'Сдача: скорее', progress: 'Готовность: по убыванию' },
    results: ruResults,
    more: 'Показать ещё',
    clear: 'Сбросить',
  ...
  de: {
    ...
    devAria: 'Bauträger',
    sortAria: 'Sortierung',
    sorts: { rec: 'Empfohlen', value: 'Günstig im Viertelvergleich', price: 'Preis: aufsteigend', 'price-desc': 'Preis: absteigend', handover: 'Übergabe: früheste', progress: 'Baufortschritt: höchster' },
