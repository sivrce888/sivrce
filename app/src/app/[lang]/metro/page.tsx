...
const DESCRIPTION =
  'თბილისის მეტროს ყველა 22 სადგური ორი ხაზზე: იყიდება და ქირავდება ბინები სადგურიდან 15 წუთიან ფეხით მანძილზე — ' +
  'გლდანი, დიდუბე, საბურთალო, ცენტრი, ვარკეთილი. ვერიფიცირებული განცხადებები, AI ფასის შეფასება და პირდაპირი კონტაქტი მესაკუთრესთან.'
