...
export const metadata: Metadata = {
  title: '3D რუკა — შენობები იყიდება, ქირავდება, დღიურად',
  description:
    'ინტერაქტიული 3D რუკა თბილისში. დააჭირე შენობას და ნახე რა იყიდება, ქირავდება ან დღიურად არის ხელმისაწვდომი.',
  openGraph: {
    title: 'sivrce 3D რუკა',
    description: 'დააჭირე შენობას — იყიდება / ქირავდება / დღიურად ერთ ადგილას.',
  },
}
    ...
    <div className="flex min-h-dvh flex-col bg-sv-navy">
      <header className="z-40 flex h-[4.5rem] shrink-0 items-center justify-between border-b border-white/8 bg-sv-navy/95 px-4 backdrop-blur-md md:h-20 md:px-8">
        ...
        <p className="hidden text-[13px] font-semibold text-white/50 sm:block">
          დააჭირე შენობას — იყიდება · ქირავდება · დღიურად
        </p>
        <Link
          href="/search"
