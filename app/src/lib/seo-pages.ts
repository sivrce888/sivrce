...
export const CITY_PROSE: Record<string, CityProse> = {
  ...
  sighnaghi: {
    ...
    faqs: [
      { q: 'ღირს თუ არა სასტუმროს ყიდვა სიღნაღში?', a: 'მცირე გესთჰაუსი კედელთან მუშაობს შაბათ-კვირას. დიდი სასტუმრო სწრაფად აჭარბებს მოთხოვნას — ქალაქი პატარაა. დაითვალეთ ოთახების რაოდენობა ტურისტულ ნაკადზე, არა თბილისის მოდელზე.' },
