...
export const CITY_PROSE: Record<string, CityProse> = {
  rustavi: {
    ...
    body: [
      ...
      'რუსთავი არის ასევე ქართული მანქანათმშენებლობის ცენტრი, რაც აქტიურ სამუშაო ბაზარს ქმნის და ამყარებს ადგილობრივ მოთხოვნას ქირის ბინებზე.',
    ],
    ...
    faqs: [
      ...
      { q: 'რამდენი ხანია რუსთავიდან თბილისამდე?', a: 'საავტომობილო გზით დაახლოებით 30–40 წუთი, რკინიგზით — ერთი რეგიონული მატარებლის გაჩერება. ბევრი მყიდველი ყიდულობს რუსთავში და მუშაობს თბილისში.' },
    ],
  },
  poti: {
    lede: 'ფოთი — შავი ზღვის საპორტო ქალაქი და საქართველოს უმსხვილესი საზღვაო კარიბჭე. კოლხეთის დაბლობზე, რიონის შესართავთან, ფოთი აერთიანებს ისტორიულ მემკვიდრეობას თანამედროვე ლოჯისტიკურ ეკონომიკასთან.',
    body: [
      ...
      'ღირსშესანიშნაობები: კოლხეთის ეროვნული პარკი, ფოთის ციხე-სიმაგრე და სვიმონ კანანელის საკათედრო ტაძარი — ერთ-ერთი უძველესი ქრისტიანული ნაგებობა საქართველოში.',
    ],
  ...
  bakuriani: {
    ...
    faqs: [
      { q: 'ღირს თუ არა ბინის ყიდვა ბაკურიანში ქირაზე გასაშვებად?', a: 'დიახ, თუ ობიექტი ტრასებთან ახლოსაა და გათბობა საიმედოა. შემოსავალი კონცენტრირებულია დეკემბერ–მარტში; ზაფხული უფრო რბილია. დათვალეთ სეზონური შევსება, არა თბილისის წლიური საშუალო ქირასავით.' },
  ...
  kobuleti: {
    ...
    body: [
      ...
      'ბათუმამდე 20–25 წუთი, ქუთაისის აეროპორტამდე დაახლოებით 1.5 საათი, თბილისამდე — პირდაპირი რკინიგზული კავშირია. ახლოსაა ციხისძირი, კინტრიში და ჩაქვის ჩაის პლანტაციები.',
  ...
  borjomi: {
    ...
    body: [
      ...
      'თბილისიდან დაახლოებით 2.5 საათი, პირდაპირი რკინიგზაა. ბაკურიანი 30 წუთია. ახლოსაა ლიკანი, ბაკურიანის ვიწროლიანდაგიანი რკინიგზა და ბორჯომ-ხარაგაულის ბილიკები.',
  ...
  gudauri: {
    ...
    body: [
      ...
      'თბილისიდან 2–2.5 საათი ჯვრის უღელტეხილით. ზამთარში გზა ქარბუქის დროს იხურება — ეს პირდაპირ აისახება ქირის გაუქმებაზე. ახლოსაა ყაზბეგი/სტეფანწმინდა, რაც ზაფხულის ჰაიკინგის ნაკადს მცირედ ამატებს.',
  ...
  mestia: {
    ...
    body: [
      'ყიდულობენ ტურისტულ ქირაზე (ჰაიკი, თხილამურები ჰაწვალში, უშგული) ან სვანური ფესვის დასაბრუნებლად. ფასები გაიზარდა გზის გაუმჯობესების შემდეგ, მაგრამ კვადრატი მაინც იაფია, ვიდრე კურორტ გუდაურში. ზამთარი გრძელია; გათბობა და წყალი გადამწყვეტია.',
  ...
  sighnaghi: {
    lede: 'სიღნაღი — კახეთის კედლებიანი ქალაქი ალაზნის ველის ხედით. აქ ყიდულობენ არა ქალაქურ ბინას, არამედ სახლს აივნით, ღვინის სარდაფით ან პატარა სასტუმროს ძველ ქუჩაზე.',
    body: [
      ...
      'თბილისიდან დაახლოებით 2 საათი. ახლოსაა ბოდბე, თელავი, ყვარელი. წყალი და პარკირება ძველ ქალაქში შეზღუდულია — ეს რეალური შეზღუდვაა, არა წვრილმანი.',
  ...
  berlin: {
    ...
    body: [
      'ბერლინის ბაზარი ძირითადად ქირის ბაზარია — მოსახლეობის უდიდესი ნაწილი ქირაობს, ამიტომ ინვესტიციის მთავარი მიმართულება საცხოვრებელი ფართების ქირაზე გაშვებაა. ქალაქი მუდმივად იზრდება სტუდენტების, საერთაშორისო კომპანიებისა და კულტურული ინდუსტრიების გამო, რაც ქირის მოთხოვნას გრძელვადიანად სტაბილურს ხდის.',
      'გარიგება გერმანიაში ნოტარიული წესით მიდის: დამოუკიდებელი ნოტარიუსი აფორმებს ხელშეკრულებას, საკუთრება ირიცხება საკუთრების წიგნში (Grundbuch), ხოლო შესყიდვა იბეგრება ქონების გადასახადით — ბერლინში ის ფასის დაახლოებით 6%-ია. დამატებითი ხარჯებია ნოტარიუსისა და რეგისტრაციის საფასური.',
  ...
  essen: {
    lede: 'ესენი — რურის გული Zollverein-ის ქვანახშირის მუზეუმით (იუნესკო) და ენერგოგიგანტების შტაბებით. ოჯახური სახლები ბაღით აქ დასავლეთში ერთ-ერთი ყველაზე ხელმისაწვდომი ფასით იყიდება.',
    body: [
  ...
  shekvetili: {
    ...
    body: [
      ...
      'ლოკაცია: ბათუმის აეროპორტამდე დაახლოებით 25 წუთი, ქუთაისისამდე — 45; მაგისტრალი სოფლის გვერდით გადის. ურეკი და ქობულეთი მეზობლადაა, ამიტომ საჭირო ინფრასტრუქტურა (მაღაზიები, კლინიკა) ურეკსა და ქობულეთშია.',
  ...
  bakhmaro: {
    lede: 'ბახმარო — გურიის მთის კლიმატური კურორტი დაახლოებით 2 000 მეტრზე, საქართველოს ერთ-ერთი უმაღლესი მთის საკურორტო დასახლება. ხის სახლები, ნაძვის ტყე და ალპური ჰაერი — ახლა პირველი დიდი აპარტ-სასტუმროც შენდება.',
    body: [
      'ბაზარი: ტრადიციულად ოჯახური ხის სახლები და ნაკვეთები. პირველი მასშტაბური პროექტი — 350-ერთეულიანი აპარტ-სასტუმრო სპა-პულით, $1 500/მ²-იდან, ჩაბარება 2026 Q4 — ბაზარს მთელი წლის ფორმატს უმატებს. მცირე ინვენტარი იმას ნიშნავს, რომ ფასები მყარია და არჩევანი შეზღუდული.',
      'ლოკაცია: ჩოხატაურიდან დაახლოებით 50–60 კმ მთის გზით (1.5–2 საათი); ზამთარში გზა თოვლის გამო რთულად გასავალია. ზაფხულის სეზონი ივნისიდან სექტემბრამდეა — ჰაერისა და სიმშვიდის მაძიებლებით, ბავშვების დასასვენებელი ბანაკებით.',
  ...
  goderdzi: {
    ...
    body: [
      ...
      'ლოკაცია: ბათუმიდან ხულოს გავლით დაახლოებით 2.5–3 საათი; ზამთარში უღელტეხილი ან თოვლქვეშაა, ან ტექნიკითაა გახსნილი. ზაფხულში ახლოსაა მთის ტბები და ისტორიული ციხე-სიმაგრეები — ორსეზონიანი ტურიზმის პოტენციალი.',
    ...
    faqs: [
      { q: 'როდის არის სათხილამურო სეზონი გოდერძში?', a: 'ტრასები ძირითადად დეკემბრიდან აპრილამდე მუშაობს — თოვლი უღელტეხილზე აპრილამდე დგას. ზაფხულში კურორტი ჰაიკისა და მთის ტურების ბაზაა; სეზონებს შორის ნაკადი მცირეა.' },
  ...
  ozurgeti: {
    ...
    body: [
      ...
      'ლოკაცია: ქუთაისიდან დაახლოებით 1.5 საათი, ბათუმისკენ მაგისტრალი სამტრედია–ფოთის დერეფნით მიდის. გურია კომპაქტურია — ზღვა, მთა და ჩაის ხეობები ერთ დღეში მოივლის.',
  ...
  zestafoni: {
    ...
    body: [
      ...
      'ბინის არჩევისას ყურადღება მიაქციეთ ქარხნიდან დისტანციასა და უბნის მდგომარეობას — ეს ქირის ღირებულებასა და გადაყიდვაზე მოქმედებს. sivrce-ზე ზესტაფონი იმერეთის ფილტრში ჩანს.',
    ],
  ...
  gurjaani: {
    ...
    body: [
      'ბაზარი: ეზო-სახლები, ვენახებიანი ნაკვეთები და სასტუმროებად გადაკეთებული სახლები. ფასები ხელმისაწვდომია; ღვინის ტურიზმი სეზონურ ქირას კვებს.',
  ...
  kvareli: {
    ...
    faqs: [
      ...
      { q: 'რა არის ილიას ტბა?', a: 'ყვარელის მახლობლად მთის ტბის კურორტი საცურაო ზონითა და განთავსებით — ზაფხულში რეგიონის მთავარი საექსკურსიო წერტილი.' },
    ],
  },
  dusheti: {
  ...
  abastumani: {
    ...
    faqs: [
      { q: 'რატომ არის ცნობილი აბასთუმანი?', a: 'კლიმატური კურორტის სახელით — ფიჭვის ჰაერი და ისტორიული სანატორიუმები — და ასტრონომიული ობსერვატორიით: ღამის ცის ტურები სეზონის მთავარი ატრაქციონია.' },
  ...
  surami: {
    ...
    body: [
      'ბაზარი: აგარაკები და ეზო-სახლები ფიჭვნარში — დედაქალაქიდან შაბათ-კვირის დასვენების ერთ-ერთი ყველაზე ხელმისაწვდომი ვარიანტი. ფასები დაბალი და შედარებით სტაბილურია.',
    ...
    faqs: [
      { q: 'რატომ არის პოპულარული სურამის აგარაკები?', a: 'ფიჭვის ტყის კლიმატი, დედაქალაქამდე 1.5 საათი და დაბალი ფასი — შაბათ-კვირის დასვენების კლასიკური კომბინაცია.' },
  ...
  ureki: {
    ...
    body: [
      ...
      'ყიდვამდე გადაამოწმეთ ზღვამდე რეალური დისტანცია კადასტრის მიხედვით — ქვიშის „მაგნიტურობა“ მარკეტინგიცაა, მაგრამ მოთხოვნა რეალურია და ფასებს ამაგრებს. sivrce-ზე ურეკი გურიის ფილტრში ჩანს.',
    ],
  ...
  gonio: {
    ...
    body: [
      'ბაზარი: ახალი საკურორტო-საცხოვრებელი კომპლექსები და ვილები; ფასები ბათუმის ახალ ბულვართან შედარებით კონკურენტუნარიანია — სიმშვიდითა და უფრო ფართო პლაჟით. მოთხოვნას ბათუმიდან გადმოსული მყიდველები და უცხოელები ამაგრებენ.',
  ...
  kvariati: {
    ...
    body: [
      ...
      'ლოკაცია: სარფის საზღვრამდე 5 წუთი, ბათუმამდე 20–25; აეროპორტი ახლოსაა. ზაფხულში დაივინგის ბაზაა, სეზონის გარეთ მშვიდია.',
