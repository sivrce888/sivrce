...
// gh→ღ for Georgian romanizations (Dighomi), English gh via dict (Highlight)
assert.equal(toGeorgian('Archi Dighomi'), 'არჩი დიღომი')
assert.equal(toGeorgian('m² Highlight'), 'მ² ჰაილაითი')
