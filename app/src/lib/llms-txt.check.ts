...
assert.ok(short.includes('/lease'), 'llms.txt missing lease hub')
...
assert.ok(com.includes('https://sivrce.com/fr'), 'com llms.txt missing France')
assert.ok(com.includes('https://sivrce.com/gb'), 'com llms.txt missing UK')
assert.ok(com.includes('https://sivrce.com/ge'), 'com llms.txt missing Georgia mirror')
