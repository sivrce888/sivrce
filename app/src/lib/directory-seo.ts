  ...
  ka: {
    ...
    faqs: [
      ...
      },
      {
        ...
        a: 'მშენებლობის ეტაპზე გასაყიდი ბინა ჩაბარებამდე, როგორც წესი, იზრდება ღირებულებაში; თბილისსა და ბათუმში გაქირავების შემოსავალი (ROI) უბნისა და ტურისტული მოთხოვნილების მიხედვით მერყეობს. შეადარეთ პროექტების ფასი, მდებარეობა და დეველოპერის სანდოობა sivrce-ზე.',
      },
    ],
  },
  en: {
...
export const PROJECT_HUBS: Record<ProjectHubKey, Record<DirLoc, DirectoryHubCopy>> = {
  ...
  installment: {
    ka: {
      ...
      prose: [
        'შიდა განვადება დეველოპერის საკუთარი დაფინანსებაა ბანკის გარეშე: იხდით პირველად შენატანს — ჩვეულებრივ ღირებულების 10–30%-ს — და დარჩენილ თანხას თვიური გადახდებით ბინის ჩაბარებამდე, ხშირად 0%-იანი პროცენტით. ეს ბინის ყიდვის ყველაზე მარტივი გზაა იპოთეკის შეწყვეტილი პროცედურების გარეშე.',
