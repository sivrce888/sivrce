...
assert.equal(isCountryAlias('georgia'), true)
assert.equal(isCountryAlias('germany'), true)
assert.equal(isCountryAlias('usa'), true)
assert.equal(isCountryAlias('us'), false)
assert.equal(COUNTRY_ALIAS.uae, 'ae')
assert.equal(COUNTRY_ALIAS.uk, 'gb')
assert.equal(COUNTRY_ALIAS.georgia, 'ge')
assert.equal(COUNTRY_ALIAS.germany, 'de')
