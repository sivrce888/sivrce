...
export const SOURCE_REGISTRY: SourceDef[] = [
  ...
  { slug: "de-alkis", country: "DE", kind: "registry", name: "ALKIS Berlin (GDI WFS)", baseUrl: "https://gdi.berlin.de/services/wfs", facts: ["address", "coordinates", "permit_status"], refreshHours: 720, access: "api", notes: "dl-de-zero-2.0. Legal lots + footprints; live via lib/map/berlin-gov → geo_features MVT." },
  { slug: "de-step-wohnen-2040", country: "DE", kind: "government", name: "StEP Wohnen 2040 (GDI WFS)", baseUrl: "https://gdi.berlin.de/services/wfs/step_wo_2040", facts: ["project_status", "coordinates", "permit_status"], refreshHours: 720, access: "api", notes: "dl-de-zero-2.0. Verified typeNames 2026-09; housing potentials + Neue Stadtquartiere." },
  ...
  { slug: "de-bplaene", country: "DE", kind: "government", name: "Bebauungspläne Berlin (GDI WFS)", baseUrl: "https://gdi.berlin.de/services/wfs/bplan", facts: ["permit_status", "project_status"], refreshHours: 168, access: "api", notes: "dl-de-zero-2.0. Verified typeNames 2026-09: b_bp_fs (festgesetzt), a_bp_iv (im Verfahren). Repealed layer skipped." },
