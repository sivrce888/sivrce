...
assert.equal(maskPhone('+49 89 2134 5601'), '+49 89 *** ****')
assert.equal(maskPhone('+49 30 8900 1240'), '+49 30 *** ****')
assert.equal(normalizePhone('555123456'), '+995 555 12 34 56')
assert.equal(formatPhone('555123456'), '+995 555 12 34 56')
assert.equal(formatPhone('+49 30 89001240'), '+49 30 89001240')
assert.equal(normalizePhone('+49 89 21345601'), '+49 89 21345601')
assert.equal(normalizePhone('+49 30 12'), null)
