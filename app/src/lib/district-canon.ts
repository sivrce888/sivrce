...
const ALIAS: Record<string, string> = {
  ...
  zghvisubani: 'ზღვისუბანი',
  zgvisubani: 'ზღვისუბანი',
  'zemo plato': 'მესამე მასივი',
  'upper plateau': 'მესამე მასივი',
  vashlijvari: 'ვაშლიჯვარი',
  sololaki: 'სოლოლაკი',
  'gldani massive': 'გლდანის მასივი',
  'gldani massiv': 'გლდანის მასივი',
  'gldanis-masivi': 'გლდანის მასივი',
  'digomis-masivi': 'დიღმის მასივი',
  zurgovana: 'ზურგოვანა',
  ...
  'ზემო პლატო': 'მესამე მასივი',
  'ვარკეთილის ზემო პლატო': 'მესამე მასივი',
  'სოფელი დიღომი': 'სოფ. დიღომი',
  'სოფელი გლდანი': 'სოფ. გლდანი',
  'old tbilisi': 'ძველი თბილისი',
