...
import { avifCardOf, blurProps, cardOf, hasLqip, isCdnMedia, lqipOf } from "./media"
...
assert.equal(
  avifCardOf(master),
  "https://cdn.sivrce.ge/uploads/2026/07/3f4b2c1a-9b2e-4c3d-8f1a-2b3c4d5e6f7a.card.avif",
)
...
for (const url of [
  ...
  assert.equal(avifCardOf(url), undefined, url)
