...
// Services front door shares the Georgia surface (indexable, GE inventory, .ge cookie).
assert.equal(hostKind('services.sivrce.ge'), 'ge')
assert.equal(sessionCookieDomain('services.sivrce.ge'), '.sivrce.ge')
...
assert.equal(sessionCookieDomain('SIVRCE.com:443'), '.sivrce.com')
