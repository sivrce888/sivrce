...
import { ensureFootprints, footprintPin, ringLabelPoint, haversineM } from './buildings'
import { ringContains } from './pick-building'

// footprintPin reads the official massing, which loads via dynamic import.

/** Massing reads come from the lazy dataset — load it before any assertion. */
async function main() {
