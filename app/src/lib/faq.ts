      ...
      items: [
        {
          ...
          a: 'sivrce არის უძრავი ქონების პლატფორმა საქართველოში: ბინები, სახლები, მიწა და კომერციული ფართები იყიდება, ქირავდება და დღიურად. ძიება დაიწყე მთავარ გვერდზე ან 3D რუკაზე — განცხადებები ვერიფიცირებულია, ფასს კი AI ადარებს ბაზარს.',
        },
        {
