      ...
      items: [
        {
          ...
          a: 'sivrce არის უძრავი ქონების პლატფორმა საქართველოში: ბინები, სახლები, მიწა და კომერციული ფართები იყიდება, ქირავდება და დღიურად გაიცემა. ძიება დაიწყეთ მთავარ გვერდზე ან 3D რუკაზე — განცხადებები ვერიფიცირებულია, ფასს კი AI ადარებს ბაზარს.',
        },
        {
          q: 'სად არის ბინები დღიურად თბილისში?',
          a: 'ბინები დღიურად თბილისში შეგიძლიათ იხილოთ sivrce-ის განყოფილებაში „დღიურად“ — გაფილტრეთ უბნის (ვაკე, საბურთალო, ძველი თბილისი), თარიღებისა და ფასის მიხედვით. დაჯავშნეთ პირდაპირ მესაკუთრესთან ჩატის მეშვეობით და გადახდამდე შეამოწმეთ ვერიფიკაცია.',
        },
        {
          q: 'სად არის ბინები დღიურად საბურთალოზე?',
          a: 'ბინები დღიურად საბურთალოზე შეგიძლიათ მოძებნოთ sivrce-ის „დღიურად“ განყოფილებაში — ვარიანტები ხელმისაწვდომია მეტროსთან, კლინიკებთან და ბიზნესცენტრებთან. შეადარეთ 1–2 ოთახიანი ვარიანტები. ფასი მოცემულია ღამეზე; წინასწარ დაჯავშნა ზოგავს თანხას.',
        },
        {
          q: 'როგორ ვიყიდო ბინა თბილისში — ვაკეში ან საბურთალოზე?',
          a: 'გამოიყენეთ ძიება ან AI ძიება („იყიდება 2 ოთახიანი ბინა ვაკეში“), მონიშნეთ რჩეულები, შეადარეთ AI ფასის ქულა და დაუკავშირდით მესაკუთრეს ან ვერიფიცირებულ აგენტს. გარიგება თქვენსა და გამყიდველს შორისაა — sivrce მყიდველს საკომისიოს არ აკისრებს.',
        },
      ],
    },
    {
      ...
      items: [
        {
          ...
          a: 'გამოიყენეთ ძიება ან AI ძიება, მონიშნეთ რჩეულები, შეადარეთ ფასები AI შეფასებით და დაუკავშირდით პირდაპირ მესაკუთრეს ან ვერიფიცირებულ აგენტს. გარიგება ფორმდება თქვენსა და გამყიდველს შორის — sivrce არ იღებს საკომისიოს მყიდველისგან.',
        },
        {
          q: 'რა არის AI ფასის შეფასება?',
          a: 'ჩვენი ხელოვნური ინტელექტი ადარებს განცხადების ფასს მსგავსი ობიექტების რეალურ მონაცემებთან — მდებარეობა, ფართობი, მდგომარეობა, სართული — და აჩვენებს ქულას 0-დან 100-მდე. მაღალი ქულა ნიშნავს სამართლიან ან საბაზროზე ხელსაყრელ ფასს.',
        },
        {
          q: 'როგორ დავჯავშნო ტური?',
          a: 'გახსენით განცხადება და დააჭირეთ ღილაკს „ტურის დაჯავშნა“ — აირჩიეთ თქვენთვის მოსახერხებელი დრო კალენდარში. აგენტი ან მესაკუთრე დაგიდასტურებთ ვიზიტს.',
        },
        {
        ...
        },
        {
          ...
          a: 'მთავარი გვერდის ძიების ველში ჩაწერეთ თავისუფალი ტექსტი — მაგალითად „ოროთახიანი ბინა ვაკეში 200 ათასამდე“. AI გააანალიზებს თქვენს მოთხოვნას და გაჩვენებთ შესაბამის განცხადებებს. მუშაობს ქართულად, ინგლისურად და სხვა ენებზე.',
        },
      ],
    },
    {
      ...
      items: [
        {
          ...
          a: 'დიახ, სტანდარტული განცხადების განთავსება სრულიად უფასოა და აქტიური რჩება 30 დღის განმავლობაში. დამატებითი ხილვადობისთვის შეგიძლიათ აირჩიოთ VIP პაკეტებიდან ერთ-ერთი.',
        },
        {
          q: 'რას იძლევა VIP პაკეტი?',
          a: 'VIP პაკეტები ზრდის თქვენი განცხადების ხილვადობას: VIP ანიჭებს გამორჩეულ ნიშანს და ძიებაში უპირატეს ადგილს, VIP+ მოექცევა მთავარი გვერდის კარუსელში, ხოლო SUPER VIP უზრუნველყოფს მაქსიმალურ ხილვადობას — საშუალოდ 5× მეტ ნახვას.',
        },
        {
        ...
        },
        {
          ...
          a: 'ვერიფიკაციისთვის აგენტი ან მესაკუთრე ტვირთავს პირადობის დამადასტურებელ დოკუმენტს და ქონების საკადასტრო ამონაწერს. ჩვენი გუნდი ამოწმებს ინფორმაციას 1-2 სამუშაო დღეში და წარმატებული შემოწმების შემდეგ განცხადებას ენიჭება ვერიფიცირებული სტატუსი.',
        },
        {
          q: 'შემიძლია რემონტის ან იურიდიული სერვისის გამოქვეყნება?',
          a: 'დიახ. sivrce-ზე მოქმედებს სერვისების სივრცე — რემონტი, ინტერიერის დიზაინი, ფოტო და 3D ტური, იურიდიული მხარდაჭერა, შეფასება, გადაზიდვა, დასუფთავება და ქონების მართვა. კომპანია აქვეყნებს სერვისს /add-service-ზე და ქონების განცხადებას იმავე ანგარიშით /add-listing-ზე. ორივე აისახება კომპანიის პროფილზე.',
        },
      ],
    },
    {
      ...
      items: [
        {
          ...
          a: 'დღეს sivrce ფარავს საქართველოს ქალაქებს — თბილისი, ბათუმი, ქუთაისი, რუსთავი, გორი, ფოთი, ზუგდიდი, თელავი, ახალციხე და სხვა რეგიონებს. არეალი მუდმივად ფართოვდება.',
        },
        {
          q: 'უსაფრთხოა პირდაპირი კონტაქტი?',
          a: 'დიახ. აგენტები გადიან მკაცრ ვერიფიკაციას. მიმოწერა მიმდინარეობს უსაფრთხოდ პლატფორმის შიგნით, რაც ინახავს ისტორიას და გიცავთ გაურკვევლობისგან. არასდროს გადარიცხოთ თანხა წინასწარ, ქონების დათვალიერებამდე და საბუთების გადამოწმებამდე.',
        },
      ],
    },
  ],
