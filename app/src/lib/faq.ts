  ...
  ka: [
    {
      ...
      items: [
        ...
        },
        {
          ...
          a: 'ბინები დღიურად თბილისში ნახავ sivrce-ის განყოფილებაში „დღიურად“ — ფილტრი უბნით (ვაკე, საბურთალო, ძველი თბილისი), თარიღით და ფასით. დააჯავშნე პირდაპირ მესაკუთრესთან ჩატით და გადახდამდე შეამოწმე ვერიფიკაცია.',
        },
        {
          q: 'სად არის ბინები დღიურად საბურთალოზე?',
          a: 'ბინები დღიურად საბურთალოზე მოძებნე sivrce-ის „დღიურად“ განყოფილებაში — ვარიანტები მეტროსთან, კლინიკებთან და ბიზნეს-ცენტრებთანაა. შეადარე 1–2 ოთახიანი ვარიანტები. ფასი მოცემულია ღამეზე; სეზონში ადრე დაჯავშნა ზოგავს თანხას.',
        },
        {
