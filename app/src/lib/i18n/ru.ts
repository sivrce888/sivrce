...
export const ru: Dict = {
  ...
  'add.f.tv': 'Телевизор',
  'add.f.workspace': 'Рабочая зона',
  'add.f.seaView': 'Вид на море',
  'add.f.mountainView': 'Вид на горы',
  'add.f.beachfront': 'У моря',
  'add.f.skiAccess': 'Доступ к лыжам',
  'add.f.bbq': 'Мангал',
  'add.f.sauna': 'Сауна',
  'add.f.gym': 'Спортзал',
  'add.f.evCharger': 'Зарядка для EV',
  'add.f.kidFriendly': 'Для детей',
  'add.f.accessible': 'Доступно для инвалидов',
  'add.f.smokingAllowed': 'Можно курить',
