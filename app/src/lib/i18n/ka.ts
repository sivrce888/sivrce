...
export const ka = {
  ...
  'add.f.tv': 'ტელევიზორი',
  'add.f.workspace': 'სამუშაო სივრცე',
  'add.f.seaView': 'ზღვის ხედი',
  'add.f.mountainView': 'მთის ხედი',
  'add.f.beachfront': 'ზღვისპირა',
  'add.f.skiAccess': 'სათხილამურო წვდომა',
  'add.f.bbq': 'მანგალი',
  'add.f.sauna': 'საუნა',
  'add.f.gym': 'სპორტდარბაზი',
  'add.f.evCharger': 'ელ. მანქანის დამტენი',
  'add.f.kidFriendly': 'ბავშვებისთვის',
  'add.f.accessible': 'გადაადგილების ხელმისაწვდომობა',
  'add.f.smokingAllowed': 'მოწევა ნებადართულია',
