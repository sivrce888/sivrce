...
assert(CMS_BLOCKS["home.hero.subtitle"] === "ბინები, სახლები და აგარაკები — იყიდება, ქირავდება ან გაიცემა დღიურად, დამოუკიდებელი განცხადებებით.", "ka hero sub")
assert(BLOCK_I18N.en["home.hero.subtitle"] === "Apartments, houses and cottages across Georgia — buy, rent or book daily, from independent listings.", "en hero sub")
