...
export default function RevealPhone({
  ...
  const shell =
    variant === 'call'
      ? `flex h-12 min-w-0 items-center justify-center gap-1.5 overflow-hidden rounded-full bg-sv-orange px-3 text-[13px] font-extrabold text-sv-ink shadow-glow-orange transition ${ease} hover:-translate-y-0.5 hover:shadow-glow-orange-lg active:scale-[0.98]`
      : variant === 'inline'
        ? `flex h-11 w-full min-w-0 items-center justify-center gap-2 overflow-hidden rounded-full bg-gradient-to-r from-sv-blue to-sv-blue-deep px-4 text-[13.5px] font-extrabold text-white shadow-glow-blue-sm transition ${ease} hover:opacity-95 active:scale-[0.99]`
        : `flex h-12 w-full min-w-0 items-center justify-center gap-2 overflow-hidden rounded-full bg-sv-orange px-4 text-[14px] font-extrabold text-sv-ink shadow-glow-orange transition ${ease} hover:-translate-y-0.5 hover:shadow-glow-orange-lg active:scale-[0.98]`
    ...
    return (
      <div className={`grid grid-cols-2 gap-2 ${className}`}>
        ...
        <a
          ...
          className="flex h-12 min-w-0 items-center justify-center gap-2 overflow-hidden rounded-full border border-sv-blue/25 bg-sv-blue/[0.06] px-3 text-[13px] font-extrabold text-sv-blue-deep transition duration-300 ease-[cubic-bezier(0.21,0.65,0.2,1)] hover:bg-sv-blue/10"
