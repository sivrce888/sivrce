        ...
        {agents.map((a, i) => (
          ...
          >
            <div className="flex items-center gap-3.5">
              <span
                aria-hidden
                className="grid h-12 w-12 shrink-0 place-items-center rounded-module bg-sv-blue/10 text-[14px] font-black text-sv-blue"
              >
                {i + 1}
              </span>
            ...
            <div className="mt-4 flex items-center justify-between border-t border-sv-ink/[0.06] pt-3 text-[13px] font-extrabold text-sv-ink/75">
              ...
              <span className="text-sv-blue group-hover:underline">პროფილი →</span>
            </div>
          </LocalizedLink>
        ))}
      </HScroll>
