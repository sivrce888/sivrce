      ...
      {state.status === 'anon' && (
        <div className="flex flex-wrap items-center gap-4">
          ...
          <Link
            ...
            className="flex h-11 items-center gap-2 rounded-full bg-sv-orange px-5 text-[13px] font-extrabold text-sv-ink shadow-glow-orange transition hover:-translate-y-0.5 hover:shadow-glow-orange-lg focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-sv-blue focus-visible:ring-offset-2"
          >
