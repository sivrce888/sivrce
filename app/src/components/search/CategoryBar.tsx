        ...
        {SEARCH_CATEGORIES.map((item) => {
          ...
          return (
            <button
              ...
              className={`group flex shrink-0 items-center gap-2 rounded-full px-3.5 py-2 text-[13px] font-extrabold transition duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-sv-primary ${
                active
