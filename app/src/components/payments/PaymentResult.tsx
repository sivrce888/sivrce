  ...
  return (
    <div className="mx-auto max-w-md rounded-card border border-sv-ink/[0.08] bg-sv-surface p-8 text-center shadow-panel-dark">
      ...
      <LocalizedLink
        ...
        className="mt-6 inline-flex items-center justify-center rounded-control bg-gradient-to-r from-sv-blue to-sv-violet px-6 py-3 text-[14px] font-extrabold text-white shadow-glow-blue-sm transition hover:shadow-glow-blue active:scale-95"
      >
        {t("pay.back")}
      </LocalizedLink>
    </div>
