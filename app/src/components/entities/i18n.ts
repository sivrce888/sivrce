...
const ka = {
  ...
  projectsShort: 'პროექტი',
  projectsShortOne: 'პროექტი',
  fromM2: 'დან',
...
const ru: Record<EntitiesKey, string> = {
  ...
  projectsShort: 'проектов',
  projectsShortOne: 'проект',
  fromM2: 'от',
...
const tr: Record<EntitiesKey, string> = {
  ...
  projectsShort: 'projeler',
  projectsShortOne: 'proje',
  fromM2: 'başlangıç',
...
const ar: Record<EntitiesKey, string> = {
  ...
  projectsShort: 'مشاريع',
  projectsShortOne: 'مشروع',
  fromM2: 'من',
  reviewsCount: 'مراجعة',
...
const he: Record<EntitiesKey, string> = {
  ...
  projectsShort: 'פרויקטים',
  projectsShortOne: 'פרויקט',
  fromM2: 'החל מ',
...
const hy: Record<EntitiesKey, string> = {
  ...
  projectsShort: 'նախագիծ',
  projectsShortOne: 'նախագիծ',
  fromM2: 'սկսած',
  reviewsCount: 'կարծիք',
...
const az: Record<EntitiesKey, string> = {
  ...
  projectsShort: 'layihə',
  projectsShortOne: 'layihə',
  fromM2: 'başlayır',
  reviewsCount: 'rəy',
...
const uk: Record<EntitiesKey, string> = {
  ...
  projectsShort: 'проєктів',
  projectsShortOne: 'проєкт',
  fromM2: 'від',
