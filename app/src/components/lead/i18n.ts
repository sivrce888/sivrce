...
const ka: LeadStrings = {
  formTitle: 'დაინტერესდით?',
  formSubtitle: 'შეავსეთ ფორმა — მესაკუთრე ან აგენტი დაგიკავშირდებათ რამდენიმე საათში',
  formSubtitleTo: (name) => `${name} დაგიკავშირდებათ — ჩვეულებრივ რამდენიმე საათში`,
  nameLabel: 'სახელი',
  namePh: 'თქვენი სახელი',
  nameErr: 'შეიყვანეთ სახელი (მინ. 2 სიმბოლო)',
  phoneLabel: 'ტელეფონი',
  phonePh: '+995 500 333 111',
  phoneErr: 'შეიყვანეთ ნომერი ფორმატით +995 XXX XX XX XX',
  messageLabel: 'შეტყობინება',
  messagePh: 'გამარჯობა! მაინტერესებს დეტალები ამ ქონების შესახებ…',
  messageErr: 'შეტყობინება უნდა შეიცავდეს მინ. 10 სიმბოლოს',
  submit: 'გაგზავნა',
  sending: 'იგზავნება…',
  successTitle: 'შეტყობინება გაიგზავნა!',
  successBody: (name) => (name ? `${name} დაგიკავშირდებათ უახლოეს დროში.` : 'დაგიკავშირდებიან უახლოეს დროში.'),
  successNote: 'მითითებულ ნომერზე მალე დაგიკავშირდებიან — გთხოვთ, უპასუხოთ ზარს.',
  continueChat: 'ჩატში გადასვლა',
  newMessage: 'ახალი შეტყობინება',
  errorTitle: 'ვერ გაიგზავნა',
  errorGeneric: 'დაფიქსირდა შეცდომა. შეამოწმეთ კავშირი და სცადეთ თავიდან.',
  rateLimited: 'ზედმეტად ბევრი მცდელობა — სცადეთ რამდენიმე წუთში.',
  retry: 'თავიდან ცდა',
  call: 'დარეკვა',
  messageAction: 'შეტყობინება',
  close: 'დახურვა',
  barLabel: 'სწრაფი კონტაქტი',
  dialogLabel: 'შეტყობინების გაგზავნა',
}
...
const kaIntent: IntentStrings = {
  tile: 'უძრავი ქონების შერჩევა / გაყიდვა',
  title: 'რა გაინტერესებთ?',
  subtitle: 'აირჩიეთ მიზანი — დაგიკავშირდებით საუკეთესო ვარიანტებით',
  intents: { buy: 'ვყიდულობ', rent: 'ვაქირავებ', daily: 'დღიურად', sell: 'ვყიდი' },
  sentence: {
    buy: 'ვეძებ შესაძენად',
    rent: 'მაქვს გასაქირავებელი ქონება',
  ...
  whenQ: 'ვადა',
  whenChips: ['რაც შეიძლება მალე', '1 თვეში', '1–3 თვე', 'ჯერ ვათვალიერებ'],
  contactQ: 'რომელ ნომერზე დაგიკავშირდეთ?',
  successNote: 'ჩვენი გუნდი დაგიკავშირდებათ შესაბამისი ვარიანტებით — ჩვეულებრივ იმავე დღეს.',
}
