...
const STRINGS = {
  ka: {
    ...
    emptyText: 'დააჭირე ნებისმიერი განცხადების გულის ხატულას — ის აქ შეინახება, შენს მოწყობილობაზე.',
  ...
  en: {
    ...
    emptyText: 'Tap the heart on any listing — it stays here, only on this device.',
  ...
  ru: {
    ...
    emptyText: 'Нажми сердце на объявлении — оно сохранится только на этом устройстве.',
  ...
  tr: {
    ...
    emptyText: 'Bir ilandaki kalbe bas — yalnızca bu cihazda saklanır.',
    searchCta: 'İlan ara',
  ...
  ar: {
    ...
    emptyText: 'اضغط القلب على أي إعلان — يُحفظ على هذا الجهاز فقط.',
  ...
  de: {
    ...
    emptyText: 'Tippe auf das Herz bei einem Inserat — es bleibt nur auf diesem Gerät.',
  ...
  he: {
    ...
    emptyText: 'לחץ על הלב במודעה — זה נשמר רק במכשיר הזה.',
  ...
  hy: {
    ...
    emptyText: 'Սեղմիր սիրտը հայտարարության վրա — պահվում է միայն այս սարքում.',
  ...
  az: {
    ...
    emptyText: 'Elanın ürəyinə bas — yalnız bu cihazda saxlanır.',
  ...
  uk: {
    ...
    emptyText: 'Натисни серце на оголошенні — воно лишається лише на цьому пристрої.',
