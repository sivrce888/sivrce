...
export const WORLD_PROJECTS: readonly WorldProject[] = [
  ...
  { slug: 'estrel-tower-berlin', name: 'Estrel Tower', cc: 'DE', city: 'Berlin', district: 'Neukölln', lat: 52.4649, lng: 13.4586, status: 'under-construction', type: 'hotel', floors: 44, description: '176 m hotel tower rising next to the Estrel Berlin on Sonnenallee — Germany\'s tallest hotel, scheduled to open in 2026.' },
  { slug: 'elbtower-hamburg', name: 'Elbtower', cc: 'DE', city: 'Hamburg', district: 'HafenCity', lat: 53.5337, lng: 9.9968, status: 'under-construction', type: 'mixed-use', floors: 64, description: '245 m tower on the Baakenhöft peninsula in HafenCity — set to be Germany\'s tallest building, anchoring the eastern HafenCity waterfront.' },
  { slug: 'grand-tower-frankfurt', name: 'Grand Tower', cc: 'DE', city: 'Frankfurt', district: 'Gallus', lat: 50.1039, lng: 8.6453, priceFrom: 400000, priceCurrency: 'EUR', yearCompleted: 2020, status: 'completed', type: 'apartment', floors: 56, description: '170 m residential tower near Frankfurt\'s exhibition grounds — one of Germany\'s tallest apartment buildings.' },
  { slug: 'one-frankfurt', name: 'ONE', cc: 'DE', city: 'Frankfurt', district: 'Gallus', lat: 50.1077, lng: 8.6486, yearCompleted: 2022, status: 'completed', type: 'commercial', floors: 47, description: 'Around 190 m office tower at Güterplatz with hotel, retail and public spaces — a new anchor on the Frankfurt skyline.' },
  { slug: 'edge-suedkreuz-berlin', name: 'EDGE Suedkreuz Berlin', cc: 'DE', city: 'Berlin', district: 'Schöneberg', lat: 52.4912, lng: 13.3745, yearCompleted: 2022, status: 'completed', type: 'commercial', floors: 34, description: 'Around 150 m timber-hybrid high-rise at Südkreuz — Germany\'s tallest wood-hybrid office building and a flagship for sustainable construction.' },
  { slug: 'krupp-guertel-essen', name: 'Krupp-Gürtel', cc: 'DE', city: 'Essen', district: 'Südviertel', lat: 51.4402, lng: 7.0076, status: 'planned', type: 'mixed-use', description: 'Masterplan on former Krupp land south of Essen Hauptbahnhof — converting industrial heritage into quarters, parks and new workplaces.' },
  { slug: 'werksviertel-munich', name: 'Werksviertel', cc: 'DE', city: 'Munich', district: 'Berg am Laim', lat: 48.1275, lng: 11.6095, status: 'under-construction', type: 'mixed-use', description: 'Former Pfanni and Wacker-Chemie works turned into a live-work district east of Ostbahnhof — offices, homes and Munich\'s most talked-about quarter.' },
  { slug: 'stuttgart-rosenstein', name: 'Rosensteinviertel', cc: 'DE', city: 'Stuttgart', district: 'Rosenstein', lat: 48.7905, lng: 9.2047, status: 'under-construction', type: 'mixed-use', description: 'Several thousand homes rising on the former Rosenstein freight yard — Stuttgart\'s largest inner-city housing project, built step by step as rail tracks move underground.' },
  { slug: 'hamburg-grasbrook', name: 'Grasbrook', cc: 'DE', city: 'Hamburg', district: 'Grasbrook', lat: 53.5213, lng: 9.9997, status: 'planned', type: 'mixed-use', description: 'New Elbe island district east of HafenCity — housing for roughly 16,000 residents with workshops, parks and flood-adapted design.' },
  { slug: 'koeln-medienpark', name: 'Medienpark Köln', cc: 'DE', city: 'Cologne', district: 'Mülheim', lat: 50.9658, lng: 6.9821, status: 'planned', type: 'mixed-use', description: 'Masterplan for the former TNT site on the Rhine in Köln-Mülheim — a mixed quarter with housing, offices and public waterfront on the right bank.' },
  ...
  // Africa
  { slug: 'lagos-riverside', name: 'Lagos Riverside', cc: 'NG', city: 'Lagos', district: 'Victoria Island', lat: 6.4652, lng: 3.4215, priceFrom: 350000, priceCurrency: 'USD', units: 500, yearCompleted: 2023, status: 'completed', type: 'apartment', description: 'Waterfront residential development on Lagos\'s premier Victoria Island.' },
  { slug: 'nairobi-green', name: 'Green Hills Estate', cc: 'KE', city: 'Nairobi', district: 'Kilimani', lat: -1.2921, lng: 36.8219, priceFrom: 280000, priceCurrency: 'USD', units: 300, yearCompleted: 2022, status: 'completed', type: 'apartment', description: 'Gated community with green spaces in Nairobi\'s upscale Kilimani estate.' },
  { slug: 'casablanca-porte', name: 'Porto Marina', cc: 'MA', city: 'Casablanca', district: 'Anfa', lat: 33.5862, lng: -7.6114, priceFrom: 420000, priceCurrency: 'USD', units: 450, yearCompleted: 2024, status: 'completed', type: 'apartment', description: 'Luxury marina residential complex in Casablanca\'s Anfa district.' },
]