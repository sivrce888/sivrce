...
export const LISTINGS: Listing[] = [
  // ——— Homepage 6 (order & figures locked with the homepage) ———
  {
    ...
    ai: { score: 100, label: 'შესანიშნავი' },
  ...
  },
  {
    ...
    ai: { score: 100, label: 'შესანიშნავი' },
    features: ['კერძო ტერასა 40 მ²', 'სარდაფიანი პარკინგი', 'სმარტ სახლი', 'კონსიერჟი 24/7', 'კამინი', 'გარდერობის ოთახი'],
  ...
  },
  {
    ...
    ai: { score: 100, label: 'შესანიშნავი' },
    features: ['გათბობილი აუზი', 'ეზო 800 მ²', 'საუნა', 'ღვინის მარანი', 'გენერატორი', 'ვიდეოდაკვირვება'],
  ...
  },
  {
    ...
    ai: { score: 100, label: 'შესანიშნავი' },
    features: ['ახალი აშენებული', 'მწვანე კარკასი', 'პარკინგი', 'ლიფტი', 'ბავშვთა მოედანი', 'add.f.installment'],
  ...
  },
  {
    ...
    ai: { score: 100, label: 'შესანიშნავი' },
    features: ['მთის ხედი', 'რემონტით', 'ბუნებრივი აირი', 'ინტერნეტი', 'კონდიციონერი', 'add.f.installment'],
  ...
  },
  {
    ...
    address: 'გუდამაყრის ქუჩა 21, დიდი დიღომი, თბილისი',
  ...
  },
  {
    ...
    address: 'კრისტესის ქუჩა 15, ორთაჭალა, თბილისი',
  ...
  },
  {
    ...
    buildingNumber: '30',
    buildingSlug: 'khizaneishvili-30',
    postedAt: '2026-05-27',
    agent: AGENTS[5]!,
    isNew: true,
  },
  {
    ...
    buildingSlug: 'agmashenebeli-alley',
    postedAt: '2026-05-24',
    agent: AGENTS[1]!,
    isNew: false,
  },
  ...
  // ——— Batumi ———
  {
    ...
    ai: { score: 100, label: 'შესანიშნავი' },
    features: ['ზღვის ხედი', 'პირველი ხაზი', 'აპარტ-სასტუმრო სერვისი', 'აუზი', 'რეცეფშენი 24/7', 'შავი კარკასი'],
    ...
    buildingNumber: '20',
    buildingSlug: 'khimshiashvili-20',
    postedAt: '2026-06-09',
    agent: AGENTS[4]!,
    isNew: true,
  },
  ...
  },
  {
    ...
    buildingSlug: 'makhinjauri-house',
    postedAt: '2026-05-29',
    agent: AGENTS[4]!,
    isNew: false,
  },
  ...
  },
  {
    ...
    description: 'ქუთაისში, ჭავჭავაძის გამზირზე, ქირავდება 2-ოთახიანი ბინა ავეჯით. აეროპორტამდე 25 წუთი. გრძელვადიანი მოიჯარეებისთვის ფასი ფასდაკლებით.',
    coords: { lat: 42.2538, lng: 42.6812 },
    buildingNumber: '21',
    buildingSlug: 'chavchavadze-21',
    postedAt: '2026-05-19',
    agent: AGENTS[3]!,
    isNew: false,
  },
  ...
  // ——— Commercial & land ———
  {
    ...
    buildingNumber: '45',
    buildingSlug: 'ketevan-dedoflis-45',
    postedAt: '2026-06-01',
    agent: AGENTS[1]!,
    isNew: false,
  },
  ...
  },
  {
    ...
    description: 'რუსთაველის გამზირზე, ოპერის თეატრთან, დღიურად ქირავდება ნათელი ბინა — სასიარულოდ საუკეთესო მდებარეობა თბილისში. ფასი მოლაპარაკებადია 3+ ღამეზე.',
    coords: { lat: 41.7008, lng: 44.7926 },
    buildingNumber: '28',
    buildingSlug: 'rustaveli-28',
    postedAt: '2026-07-08',
    agent: AGENTS[0]!,
    isNew: true,
  },
  ...
  },
  {
    ...
    description: 'ვაკეში, ვაკის პარკთან ახლოს, დღიურად ქირავდება ერთოთახიანი ბინა. მშვიდი, უსაფრთხო უბანი ბიზნეს-მგზავრებისა და ოჯახებისთვის. მეტრომდე და ჭავჭავაძის გამზირამდე 5 წუთი.',
    coords: { lat: 41.7078, lng: 44.7647 },
    buildingNumber: '24',
    buildingSlug: 'abashidze-24',
    postedAt: '2026-07-03',
    agent: AGENTS[0]!,
    isNew: false,
  },
  {
    ...
    buildingNumber: '50',
    buildingSlug: 'vazha-pshavela-50',
    postedAt: '2026-06-25',
    agent: AGENTS[1]!,
    isNew: false,
  },
  ...
  // ——— Coverage samples: villa + hotel (all prop types) ———
  {
    ...
    city: 'თბილისი', district: 'ლისი',
    dealType: 'sale', propType: 'villa',
    rooms: 5, beds: 4, baths: 3, area: 180, floor: 0, totalFloors: 2,
    views: 980, badge: 'VIP',
    ai: { score: 100, label: 'შესანიშნავი' },
    features: ['აგარაკი', 'აუზი', 'ეზო', 'პარკინგი', 'გათბობა'],
    description: 'ლისის ტბასთან აგარაკი 180 მ², 2 სართული, კერძო ეზო და აუზი. იდეალური ოჯახისთვის.',
    coords: { lat: 41.7512, lng: 44.7358 },
    buildingNumber: '—',
    buildingSlug: 'lisi-lake-villa',
    postedAt: '2026-07-20',
    agent: AGENTS[3]!,
    isNew: true,
  },
  {
    ...
    city: 'მცხეთა', district: 'მცხეთა',
    dealType: 'rent', propType: 'villa',
    rooms: 4, beds: 3, baths: 2, area: 150, floor: 0, totalFloors: 2,
    views: 540, badge: null,
    ai: { score: 100, label: 'შესანიშნავი' },
  ...
  },
  {
    ...
    address: 'სულინას ქუჩა 1, ახალი ბულვარი, ბათუმი',
    city: 'ბათუმი', district: 'ახალი ბულვარი',
    dealType: 'sale', propType: 'hotel',
    rooms: 24, beds: 24, baths: 24, area: 500, floor: 0, totalFloors: 5,
    views: 2100, badge: 'SUPER VIP',
    ai: { score: 100, label: 'შესანიშნავი' },
    features: ['სასტუმრო', 'ბულვარი', 'რესტორანი', 'პარკინგი', 'ლიფტი'],
    description: 'მოქმედი სასტუმრო 24 ოთახით, პირველ ხაზზე. რესტორანი და მიწისქვეშა პარკინგი.',
    coords: { lat: 41.6495, lng: 41.6367 },
    buildingNumber: '—',
    buildingSlug: 'batumi-boulevard-hotel',
    postedAt: '2026-07-16',
    agent: AGENTS[4]!,
    isNew: true,
  },
  {
    ...
    dealType: 'daily', propType: 'hotel',
    rooms: 8, beds: 8, baths: 8, area: 280, floor: 0, totalFloors: 3,
