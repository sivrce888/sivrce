...
/**
 * oEmbed-verified video tours only (checked 2026-09-25): the embed must exist
 * on YouTube AND depict this project. The former 219-entry map reused ~10
 * generic skyline videos across unrelated projects and shipped dead IDs on
 * every Georgian page — re-add an entry only with a verified, matching ID.
 */
